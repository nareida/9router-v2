...
export async function GET(req, res) {
  try {
    ...
    return res.status(500).json({ error: "Failed to check codex settings" });
  }
}
...
export async function POST_handler(req, res) {
  try {
    ...
    return res.status(500).json({ error: "Failed to update codex settings" });
  }
}
...
export async function DELETE(req, res) {
  try {
    ...
    return res.status(500).json({ error: "Failed to reset codex settings" });
  }
}
